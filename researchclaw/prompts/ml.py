...
_DEFAULT_STAGES: dict[str, dict[str, Any]] = {
    ...
    "code_generation": {
        ...
        "user": (
            ...
            "while loss looks fine). If validity is still 0 after a FULL epoch → "
            "control.should_training_stop=True and surface it, instead of burning the "
            "rest of a multi-hour run. This is the layer between pre-flight smoke "
