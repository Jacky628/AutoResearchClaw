...
_DEFAULT_STAGES: dict[str, dict[str, Any]] = {
    ...
    "code_generation": {
        ...
        "user": (
            ...
            "TRUNCATE it at the program boundary: strip everything after EOS, "
            "and for executable code cut at the first complete program (last "
            "syntactically-valid statement / matching close), so a rambling "
            "model is scored on its valid prefix, NEVER on 'valid program + "
            "trailing garbage'. Feeding the raw full-length generation to the "
            "oracle is a bug.\n"
