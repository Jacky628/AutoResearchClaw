...
_DEFAULT_STAGES: dict[str, dict[str, Any]] = {
    ...
    "code_generation": {
        ...
        "user": (
            ...
            "boundary extractor that, EVEN WITH NO EOS, returns the longest "
            "leading prefix that parses/executes as a complete program (last "
            "syntactically-valid statement / matching close / for CAD up to the "
            "final successful Workplane op), and apply it in EVERY validity-eval "
            "path. Scoring the raw full-length generation is a bug that silently "
            "zeroes a model whose early output was fine.\n"
